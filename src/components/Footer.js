...
const Footer = () => {
  ...
  return (
    <div className="flex flex-col bg-footerbg gap-5">
      <div className="flex flex-col pt-5 pl-5 gap-5 sm:flex-row">
        <h1 className="font-sand font-bold text-lg sm:mt-10 mt-5 lg:mt-12 sm:text-xl md:text-2xl xl:text-3xl sm:mr-10">
          Lorem ipsum dolor sit amet, <br/>consectetur adipiscing elit
        </h1>

        <nav className="flex flex-col font-pop xl:mt-5 text-sm gap-1 md:gap-2 pt-2">
          {links.map((link, i) => {
            return (
              <Link
                key={i}
