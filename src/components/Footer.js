...
const Footer = () => {
  ...
  return (
      ...
      <div className="flex flex-col bg-footerbg gap-5 relative z-30">
        <div className="flex flex-col md:pt-40 md:mb-10 mb-2 pl-5 gap-5 xsm:flex-row xsm:pt-32 xsm:gap-12 xsm:-mt-20 xl:gap-32">
          <h1 className=" font-bold text-lg sm:mt-10 mt-5 lg:mt-12 sm:text-xl md:text-2xl xl:text-3xl sm:mr-10 xsm:mt-8 ">
            Lorem ipsum dolor sit amet, <br />
            consectetur adipiscing elit 
          </h1>

          <nav className="flex flex-col font-pop xl:mt-5 text-sm gap-1 md:gap-2 pt-2 md:text-base pl-10 xsm:pl-0">
            {links.map((link, i) => {
              return (
                <Link
                  key={i}
