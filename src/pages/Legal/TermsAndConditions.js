const TermsAndCondition = () => {
    return (
        <div className="mb-1 legal pl-1 pr-2 flex flex-col gap-1">
            ...
            <div className="font-sarabun flex flex-col gap-5">
                <p>
                ...
                <p>
                    The halolegion app stores and processes personal data that you have provided to us, in order to provide our Service. It’s your responsibility to keep your phone and access to the app secure. We therefore recommend that you do not jailbreak or root your phone, which is the process of removing software restrictions and limitations imposed by the official operating system of your device. It could make your phone vulnerable to malware/viruses/malicious programs, compromise your phone’s security features and it could mean that the halolegion app won’t work properly or at all.
                </p>
                <p>
            ...
            <div className="font-sarabun flex flex-col gap-5">
                ...
                <p>
                    Along the same lines, DPS Indore cannot always take responsibility for the way you use the app i.e. You need to make sure that your device stays charged – if it runs out of battery and you can’t turn it on to avail the Service, DPS Indore cannot accept responsibility.
                </p>
                <p>
                    With respect to DPS Indore’s responsibility for your use of the app, when you’re using the app, it’s important to bear in mind that although we endeavour to ensure that it is updated and correct at all times, we do rely on third parties to provide information to us so that we can make it available to you. DPS Indore accepts no liability for any loss, direct or indirect, you experience as a result of relying wholly on this functionality of the app.
                </p>
            ...
            <div className="font-sarabun flex flex-col gap-3">
                <p>
