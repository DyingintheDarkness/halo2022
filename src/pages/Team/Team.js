...
const Team = () => {
  ...
  return (
    <Layout>
      <div className="mt-20 sm:mt-10 flex justify-center lg:mb-10 mb-5 lg:mt-10 xsm:mt-24">
      ...
      <div className="flex flex-col justify-center items-center relative mb-10 ">
        ...
        <svg
          ...
          className=" z-40 w-7 h-7 absolute left-0 sm:top-52 md:top-64 sm:w-10 sm:h-10"
          viewBox="0 0 64 70"
          fill="none"
        ...
        <svg
          onClick={nextMember}
          className=" z-40 w-7 h-7 absolute right-0 sm:top-52 md:top-64 sm:w-10 sm:h-10"
          viewBox="0 0 64 70"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          >
        ...
        <div className="mt-5 select-none">
          <img
            src={member.img}
            alt=""
            className="member-img w-32 xsm:w-40 lg:w-60 sm:ml-60 shadow-md lg:ml-80 h-30"
          />
        ...
        <p className="font-pop text-sm mt-7 ml-3 xsm:w-3/4 sm:mr-20 pr-1 xsm:pr-0 sm:w-3/4 md:w-1/2 lg:w-2/6">
          {member.about}
        </p>
