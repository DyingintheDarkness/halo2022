      ...
      <div className="font-pop flex flex-col gap-10 items-center mt-16 sm:mt-8 pl-2  relative z-30 mb-20">
        ...
        <div className="flex flex-col justify-center items-center gap-7 mb-10 xsm:flex-wrap xsm:flex-row xl:w-10/12 xl:gap-x-12">
          ...
          {resources.map((resource) => {
            return (
              <div
                className="shadow-spread-md bg-white relative w-60 h-32 flex items-center flex-col justify-evenly rounded-md xsm:w-80 xsm:h-40"
                key={resource.name}
              >
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="font-pop font-medium bg-green_1 w-40 h-7 rounded-md flex items-center justify-center -mb-5 text-sm md:text-base md:h-8 md:w-60"
                >
                  View Resources
                </Link>
